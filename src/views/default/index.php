            ...
            <div class="card">
                <div class="card-header bg-secondary">
                    ...
                    <div class="card-widgets text-white float-right">
                        <a data-toggle="collapse" href="#group-<?= $group ?>" class="btn btn-outline-light btn-sm ml-2" role="button" aria-expanded="true" aria-controls="group-<?= $group ?>"><i class="mdi mdi-minus"></i></a>
                    </div>
                            ...
                            <div class="col-lg-6 col-12 border-left">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <?php elseif ($item->type === $item::TYPE_PHP): ?>
